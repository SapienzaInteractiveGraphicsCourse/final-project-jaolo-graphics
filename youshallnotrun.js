...
function init() {
  ...
  audio_loader.load( 'https://././res/sounds/theshire.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://././res/sounds/swamp-sounds.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://././res/sounds/gameover.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://././res/sounds/no.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://././res/sounds/arrow.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://././res/sounds/cauldron.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://././res/sounds/coins.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://././res/sounds/powerup2.mp3', function( buffer ) {
  ...
  // tutorial 
  page_current = 0;
  var page_1 = texture_loader.load("https://././res/howto/HowToPlay1.png");
  ...
  var page_2 = texture_loader.load("https://././res/howto/HowToPlay2.png");
  page_2.encoding = THREE.sRGBEncoding;
  page_2.anisotropy = 16;
  tutorial_array.push(page_2);
  var page_3 = texture_loader.load("https://././res/howto/HowToPlay3.png");
  page_3.encoding = THREE.sRGBEncoding;
  page_3.anisotropy = 16;
  tutorial_array.push(page_3);

  // logo
  var logo = texture_loader.load("https://././res/textures/logo_gandalf.png");
 ...
 */
 function loadHUD() {
  ...
  for (var i = 1; i <= healthPoints; i++) {
    ...
    logo.src = "https://././res/textures/Health-potion.png";
    logo.alt = " ";
    logo.height = "60";
    logo.width = "60";
  ...
  logo.src = "https://././res/textures/coinx2.png";
  logo.alt = " ";
  logo.height = "100";
  logo.width = "100";
