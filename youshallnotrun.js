...
function init() {
  ...
  audio_loader.load( 'https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/sounds/theshire.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/sounds/swamp-sounds.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/sounds/gameover.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/sounds/no.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/sounds/arrow.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/sounds/cauldron.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/sounds/coins.mp3', function( buffer ) {
  ...
  audio_loader.load( 'https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/sounds/powerup2.mp3', function( buffer ) {
  ...
  // logo
  var logo = texture_loader.load("https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/textures/logo_gandalf.png");
 ...
 */
 function loadHUD() {
  ...
  for (var i = 1; i <= healthPoints; i++) {
    ...
    logo.src = "https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/textures/Health-potion.png";
    logo.alt = " ";
    logo.height = "60";
    logo.width = "60";
  ...
  logo.src = "https://sapienzainteractivegraphicscourse.github.io/final-project-jaolo-graphics/res/textures/coinx2.png";
  logo.alt = " ";
  logo.height = "100";
  logo.width = "100";
